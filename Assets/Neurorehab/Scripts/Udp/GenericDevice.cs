...
namespace Neurorehab.Scripts.Udp
{
    public class GenericDevice
    {
        ...
        /// <summary>
        /// DateTime storing the last time any <see cref="StringValues"/> was added to the <see cref="Values"/> dictionary. It represents the last time this device received any kind of data from any id and it is used to determine if it must be destroyed or not.
        /// </summary>
